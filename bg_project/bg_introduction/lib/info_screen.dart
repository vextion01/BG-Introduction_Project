    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 237.0, end: 52.6),
            Pin(size: 1.0, middle: 0.5227),
            child: SvgPicture.string(
              _svg_t1wv7g,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Align(
            alignment: Alignment(0.08, 0.002),
            child: SizedBox(
              width: 136.0,
              height: 19.0,
              child: Text(
...
const String _svg_t1wv7g =
    '<svg viewBox="70.4 334.0 237.0 1.0" ><path transform="translate(70.4, 334.0)" d="M 0 0 L 237 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
