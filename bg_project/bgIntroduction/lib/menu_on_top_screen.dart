                      ...
                      PageLink(
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            Align(
                              alignment: Alignment(-0.25, -0.267),
                              child: SizedBox(
                                width: 160.0,
                                height: 20.0,
                                child: Text(
                      ...
                      children: <Widget>[
                        Stack(
                          children: <Widget>[
                            ...
                            Align(
                              alignment: Alignment(-0.43, -0.067),
                              child: SizedBox(
                                width: 122.0,
                                height: 20.0,
                                child: Text(
...
const String _svg_udnmn5 =
    '<svg viewBox="0.0 56.0 360.0 584.0" ><path transform="translate(0.0, 56.0)" d="M 0 0 L 360 0 L 360 584 L 0 584 L 0 0 Z" fill="#ffffff" fill-opacity="0.0" stroke="#707070" stroke-width="1" stroke-opacity="0.0" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
